package com.twitter.api.events
{
        ...
        public class TwitterEvent extends Event
        {
				...
				public static const ON_RE_TWEET_BY_ME_RESULT: String = "onReTweetByMeResult";
                ...
                public static const ON_HOME_TIMELINE_RESULT : String = "onHomeTimelineResult";
                public static const ON_SET_STATUS : String = "onSetStatus";
                public static const ON_RE_TWEET : String = "onReTweet";
                ...
                public static const ON_FRIEND_CREATED:String = "onFriendCreated";
