package view.capitol
{
	...
	public class AloneView extends MovieClip implements IPageView
	{
...
//			
		...
		private function init(e:ViewEvent) : void {
			...
			_pageInfo = DataModel.appData.getPageInfo("alone");
			_bodyParts = _pageInfo.body;
			
			var genderInt:int = DataModel.defenderInfo.gender;
			...
			for each (var part:StoryPart in _bodyParts) 
			{
				if (part.type == "text") {
					...
					copy = StringUtil.replace(copy, "[gender1]", _pageInfo.gender1[genderInt]);
