package view.joylessMountains
{
	...
	public class PlaySongView extends MovieClip implements IPageView
	{
		...
		private function init(e:Event) : void {
			...
			_bodyParts = DataModel.appData.playSong.body; 
			...
			for each (var part:StoryPart in _bodyParts) 
			{
				if (part.type == "text") {
					...
					copy = StringUtil.replace(copy, "[instrument1]", DataModel.appData.playSong.instrument1[DataModel.defenderInfo.instrument]);
			...
			// decision
			_nextY += DataModel.appData.playSong.decisionsMarginTop
			_decisions = new DecisionsView(DataModel.appData.playSong.decisions,0xFFFFFF,true); //tint it white, showBG
			_decisions.y = _nextY;
