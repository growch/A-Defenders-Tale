package view.joylessMountains
{
	...
	public class DinnerView extends MovieClip implements IPageView
	{
		...
		private function init(e:Event) : void {
			...
			_bodyParts = DataModel.appData.dinner.body; 
			...
			for each (var part:StoryPart in _bodyParts) 
			{
				if (part.type == "text") {
					...
					copy = StringUtil.replace(copy, "[companion1]", DataModel.appData.dinner.companion1[DataModel.defenderInfo.companion]);
					copy = StringUtil.replace(copy, "[companion2]", DataModel.appData.dinner.companion1[DataModel.defenderInfo.companion]);
			...
			// decision
			_nextY += DataModel.appData.dinner.decisionsMarginTop
			_decisions = new DecisionsView(DataModel.appData.dinner.decisions,0xFFFFFF,true); //tint it white, showBG
			_decisions.y = _nextY;
