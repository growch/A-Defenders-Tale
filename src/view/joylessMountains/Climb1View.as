...
//			_emitter = null;
		...
		private function init(e:Event) : void {
			...
			_bodyParts = DataModel.appData.climb1.body; 
			...
			for each (var part:StoryPart in _bodyParts) 
			{
				if (part.type == "text") {
					...
					copy = StringUtil.replace(copy, "[companion1]", DataModel.appData.climb1.companion1[DataModel.defenderInfo.companion]);
					copy = StringUtil.replace(copy, "[companion2]", DataModel.appData.climb1.companion1[DataModel.defenderInfo.companion]);
			...
			// decision
			_nextY += DataModel.appData.climb1.decisionsMarginTop
			_decisions = new DecisionsView(DataModel.appData.climb1.decisions,0xFFFFFF,true); //tint it white, showBG
			_decisions.y = _nextY;
