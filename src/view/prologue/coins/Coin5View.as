package view.prologue.coins
{
	...
	public class Coin5View extends MovieClip implements IPageView
	{
		...
		private function init(e:Event) : void {
			...
			_bodyParts = DataModel.appData.coin5.body;
			// set the text
			...
			// decision
			_nextY += DataModel.appData.coin5.decisionsMarginTop;
			_decisions = new DecisionsView(DataModel.appData.coin5.decisions);
			_decisions.y = _nextY;
