...
//			_bodyParts = _pageInfo.body;
			...
			//put fish back on top
			_mc.addChild(_mc.clown_mc);
			_mc.addChild(_mc.fish2_mc);
			_mc.addChild(_mc.fish3_mc);
			_mc.addChild(_mc.fish4_mc);
...
//			_decisions.y = _nextY; FIXED BG HEIGHT
			_decisions.y = _mc.bg_mc.height - 480;
...
//			_mc.bg_mc.height = frameSize;
		...
		private function pageOn(e:ViewEvent):void {
			_mc.fish2_mc.goLeft = true;
			_mc.fish3_mc.goLeft = true;
			_mc.fish4_mc.goLeft = false;  
			_mc.clown_mc.goLeft = false;
			_mc.fish4_mc.orientRight = true; 
			_mc.clown_mc.orientRight = true;
...
//				TweenMax.pauseAll();
				...
				moveFish(_mc.fish2_mc, .8);
				moveFish(_mc.fish3_mc, .6);
				moveFish(_mc.fish4_mc, .4);
				moveFish(_mc.clown_mc, .4);
