package view.sandlands
{
	...
	public class Sand2View extends MovieClip implements IPageView
	{
		...
		{
			_SAL = new SWFAssetLoader("sandlands.Sand2MC", this);
		...
		private function init(e:ViewEvent) : void {
			...
			DataModel.getInstance().setGraphicResolution(_mc.bucket_mc);
			
			_pageInfo = DataModel.appData.getPageInfo("sand2");
...
//			_decisions = new DecisionsView(DataModel.appData.sand.decisions,0x040404,true); //tint it, showBG
			...
			_secondSound = new Track("assets/audio/sandlands/sandlands_SL_12_DIGGING.mp3");
