package view.sandlands
{
	...
	public class Well2View extends MovieClip implements IPageView
	{
		...
		private var _graphicSoundPlayed:Boolean;
		
		public function Well2View()
		{
			_SAL = new SWFAssetLoader("sandlands.Well2MC", this);
...
//			
		...
		private function init(e:ViewEvent) : void {
			...
			_pageInfo = DataModel.appData.getPageInfo("well2");
			_bodyParts = _pageInfo.body;
			
			//GRAPHICS
			DataModel.getInstance().setGraphicResolution(_mc.bg_mc);
			DataModel.getInstance().setGraphicResolution(_mc.ravens_mc);
...
//			trace(_dragVCont.scrollY);
			if (_dragVCont.scrollY >= 900 && !_graphicSoundPlayed) {
				graphicSound();
				_graphicSoundPlayed = true;
			}
