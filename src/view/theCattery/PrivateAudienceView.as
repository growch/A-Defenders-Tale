package view.theCattery
{
	...
	import assets.PrivateAudienceMC;
	...
	{
		private var _mc:PrivateAudienceMC;
...
//			TweenMax.from(_mc, 2, {alpha:0, delay:0, onComplete:pageOn});
		...
		private function shineOn():void {
			TweenMax.to(_mc.vizier_mc.shine_mc, .8, {y:150, ease:Quad.easeIn, delay:4, onComplete:resetReplay}); 
		}
